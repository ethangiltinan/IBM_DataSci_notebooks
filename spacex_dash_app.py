...
def update_scatter_chart(selected_site, payload_range):
    ...
    if selected_site == 'ALL':
        ...
        site_filtered_df = spacex_df[spacex_df['Launch Site'] == selected_site]
        filtered_df = site_filtered_df[mask]
        fig = px.scatter(filtered_df,x='Payload Mass (kg)',y='class',color='Booster Version Category',title=f'Correlation between Payload and Success for {selected_site}'
        )
        return fig
